...
const WorkFlowContextModal: React.FC<WorkFlowContextModalProps> = ({ isOpen, onClose, onDeleteOpen, onRenameOpen }) => {
  ...
  return (
    <div
      className="absolute left-0-minus top-0 text-white rounded-md shadow-lg bg-dark border border-gray-light z-10"
      onClick={handleBackdropClick}
      onKeyDown={handleKeyDown}
      tabIndex={-1}
    >
      <div className=" shadow-lg w-52 icon-light">
        {/* Modal Content */}
